...
class TokenManager:
    ...
    def create_token(self, access_lifetime: int | None = 86400, refresh_lifetime: int  = None):
        """
        ...
        self.access_token = CustomAccessToken.for_user(self.user, lifetime=access_lifetime)
